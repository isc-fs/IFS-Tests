 ...
 * Mark Alumni
 */
export const markAlumniMutation = (options?: Partial<Options<MarkAlumniData>>): UseMutationOptions<MarkAlumniResponse, MarkAlumniError, Options<MarkAlumniData>> => {
    const mutationOptions: UseMutationOptions<MarkAlumniResponse, MarkAlumniError, Options<MarkAlumniData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await markAlumni({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
 ...
 */
export const endMockMutation = (options?: Partial<Options<EndMockData>>): UseMutationOptions<EndMockResponse, EndMockError, Options<EndMockData>> => {
    const mutationOptions: UseMutationOptions<EndMockResponse, EndMockError, Options<EndMockData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await endMock({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
